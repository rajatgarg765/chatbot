        ...
        while(flag==True):
          ...
          if(user_response!='bye'):
            if(user_response=='thanks' or user_response=='thank you'):
              flag=False
              return render_template('index1.html',text="Bot: You are welcome..")
            else:
              if (greet(user_response)!=None):
                  res="Bot: "+greet(user_response)
                  return render_template('index1.html',text=res)
              else:
                ...
                return render_template('index1.html',text=res1)
                
          else:
            flag=False
            return render_template('index1.html',text="Bot: Goodbye!1 TAKE care")
